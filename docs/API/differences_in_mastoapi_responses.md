...
- `emoji_reactions`: A list with emoji / reaction maps. The format is `{emoji: "☕", count: 1, account_ids: [...]}`. Contains no information about the reacting users, for that use the `emoji_reactions_by` endpoint.
